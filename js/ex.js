...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const DISTRICT_DATA = [
    ...
    { name: "Paro",              desc: "Ancient valley with Bhutan's only international airport and the revered Tiger's Nest monastery." },
